...
<!--TERMINA HEADER Y NAVBAR PRO-->
    ...
    $query = "SELECT p.id_publicacion, p.titulo, p.contenido, p.imagen_publicacion, u.nombre_usuario, p.fecha_publicacion
            ...
            <div class="row">
                                ...
                                <div class="single-blog">
                                    <div class="blog-img">
                                        <a href="blog-single-sidebar.php?id=<?= $publicacion['id_publicacion'] ?>">
                                            <img src="<?= $publicacion['imagen_publicacion'] ?: 'https://via.placeholder.com/370x215' ?>" alt="<?= $publicacion['titulo'] ?>">
                                        </a>
                                    </div>
                                    <div class="blog-content">
                                        <a class="category" href="javascript:void(0)">Categoría</a>
                                        <h4>
                                            <a href="blog-single-sidebar.php?id=<?= $publicacion['id_publicacion'] ?>"><?= $publicacion['titulo'] ?></a>
                                        </h4>
                                        <div class="button">
                                            <a href="blog-single-sidebar.php?id=<?= $publicacion['id_publicacion'] ?>" class="btn">Leer Más</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single Blog -->
                ...
                <aside class="col-lg-4 col-md-12 col-12">
                    <div class="sidebar blog-grid-page">
                        <!-- Aquí irían los widgets, que puedes dejar igual o adaptar -->
