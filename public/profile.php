        ...
        <div class="d-flex flex-wrap align-items-start">
            ...
            <div class="col-7 profile-info-name">
                ...
                <div class="col profile-info mt-3 mt-md-0" style="margin-top: 20px">
                    <ul>
                    <?php
                    setlocale(LC_TIME, 'es_ES.UTF-8'); // Configurar la localización en español
                    ?>
                    <center>
                        <li><p>RANGO</p></li>
                        ...
                        <li><p class="text-muted"><?php echo htmlspecialchars(strftime("%d %b %Y", strtotime($_SESSION['fecha_registro']))); ?></p></li>
